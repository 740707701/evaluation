<template>
  <div class="agreement">
    <div class="container">
        <p class="title">职业测评系统用户注册免责条款</p>
        <p>尊敬的用户,欢迎您注册成为本网站用户。在注册前请您仔细阅读如下服务条款：</p>
        <p>本服务协议双方为本网站与本网站用户,本服务协议具有合同效力。您确认本服务协议后,本服务协议即在您和本网站之间产生法律效力。请您务必在注册之前认真阅读全部服务协议内容,如有任何疑问,可向本网站咨询。</p>
        ...
        <p>(a)用户需要在本网站上进行推广,而授权本网站透露这些信息。</p>
        ...
        <p>6.服务条款的修改</p>
        <p>本网站有权在必要时修改服务条款,本网站服务条款一旦发生变动,将会在重要页面上提示修改内容。如果不同意所改动的内容,用户可以主动联系本网站,进行取消获得的本网站信息服务。如果用户继续享用本网站信息服务,则视为接受服务条款的变动。本网站保留随时修改或中断服务而不需通知用户的权利。本网站行使修改或中断服务的权利不需对用户或第三方负责。</p>
        <p>7.用户隐私制度</p>
        ...
        <p>12.结束服务</p>
        <p>用户或本网站可随时根据实际情况中断一项或多项服务。本网站不需对任何个人或第三方负责而随时中断服务。用户若反对任何服务条款的建议或对后来的条款修改有异议或对本网站服务不满,用户可以行使如下权利:</p>
        <p>(1)不再使用本网站信息服务。</p>
        <p>(2)通知本网站停止对该用户的服务。结束用户服务后,用户使用本网站服务的权利马上中止。从那时起,用户没有权利,本网站也没有义务传送任何未处理的信息或未完成的服务给用户或第三方。</p>
        <p>13.通告</p>
        <p>所有发给用户的通告都可通过重要页面的公告或电子邮件或常规的信件传送。服务条款的修改、服务变更、或其它重要事件的通告都会以此形式进行。</p>
        <p>14.信息内容的所有权</p>
        <p>本网站定义的信息内容包括:文字、软件、声音、相片、录象、图表;在广告中全部内容;本网站为用户提供的其它信息。所有这些内容受版权、商标、标签和其它财产所有权法律的保护。所以,用户只能在本网站和广告商授权下才能使用这些内容,而不能擅自复制、再造这些内容或创造与内容有关的派生产品。</p>
        <p>15.法律</p>
