	...
	tagInfoList: [
		...
		},
		{
			...
			msg: `1.电话号码是用人单位联系面试者的最常用工具，保持电话畅通才不会漏过每一个面试邀约。
						2.电话为外地号码，可能会影响HR对该求职者电话邀约的可能性，HR也会顾虑面试成本、该求职者的稳定性等。
						3.如果获得HR短信通知面试，请查询官网电话，予以确认，以防上当受骗。`
		},
		{
			type: `base`,
			name: `联系邮箱`,
			msg: `1.请每天查阅邮箱，请确保邮箱服务器没有爆满。
		...
		
		{
			type: `base`,
			name: `婚姻状况`,
			msg: `1.女性求职者在适婚年龄可能会涉及到婚假、产假等带薪假期，会对企业工作连续性、用工成本造成一定的影响。
		...
		},
		{
			type: `expect`,
			name: `期望职能/职位`,
			msg: `1.期望的职位最好与实习经历有一定内在关联性，这可能意味着你有更丰富的相关工作经验。期望薪资是求职者心里对该岗位及公司所能给到的待遇的一个预估及对自我情况的判断。
						2.期望的职位最好与本人的实际能力匹配，提前了解HR对该岗位的基本要求，包括工作年限，工作经验等。
		...
		},
		{
			type: `evaluate`,
			name: `自我评价`,
			msg: `请选择自我评价从性格特征、人际处事与沟通风格、职业价值观、工作能力、实践经验等多角度描述自我，突出与应聘岗位相关的重点与特长。
						1.高度凝练的表达，有助于HR快速了解应聘者的全貌。
		...
		},
		{
			type: `workexper`,
			name: `工作时间`,
			msg: `1.请确认实习实践的描述按倒叙进行。
						2.最近一次的工作经验，往往代表了过往多次实习实践后的成果。`
		},
		{
			type: `workexper`,
			name: `公司名称`,
			msg: `1.HR可根据求职者经历过的公司来判断该求职者适合的工作氛围及已习得的工作方式，国企、上市公司、私企等的作息、工作饱和度均不同，若此公司为创业型公司，对一直在国企的员工求职也会考虑该求职者的工作主动性、抗压能力及稳定性。
		...
		},
		{
			...
			msg: `1.全职一般指求职者为满足该岗位需求的可签署劳动合同的自然人，毕业生已取得学历证、学位证，且人事档案、组织关系等根据招聘方需求可选择转入该公司，公司为全职员工依法缴纳社保公积金等，正常情况下员工要保证每周不低于40小时的上班时间。
						...
						3.全职实习指还未取得学位证、毕业证的学生劳动单位进行工作，但工作时间与全职员工一致，签署实习协议，如能留任则签署“三方协议”，等拿到毕业证、学位证之后签署正式劳动合同。实习期间不缴纳社保、公积金，报酬可按月计算，也可按出勤天数计算。
		...
		},
		{
			type: `workexper`,
			name: `工作描述`,
			msg: `1.工作经验的描述，建议站在HR的绩效考核的角度，全面描述在该单位的全程工作过程，参与多工种、多岗位的，宜重点突出，繁简有度。如校内实践成果突出，亦可在此罗列。
						2.描述内容应包括在职期间，具体负责什么，协助什么，参与什么，讲清楚自己的职业边界在哪里。
						3.描述内容还应包括在职期间取得怎样的重大工作成果，或获得哪方面的具体经验。
...

		{
			type: `school`,
			name: `校内职务与荣誉`,
			msg: `1.校级、院级的职务和班长等职务均能一定程度体现该求职者的团队合作、协调能力。
						2.填写顺序有规律，可按照校级顺序、院级顺序、班级顺序进行。若奖项过多，则罗列与岗位匹配且含金量高的2~3项即可。`
		},
		{
			type: `skill`,
			name: `技能证书`,
			msg: `拥有专业证书，是提高求职竞争力的重要筹码，如有继续学习考试的计划，也可弥补证书不够的短板。
						1.与岗位匹配度较高的国家认可的证书。
						2.语言能力成绩/证书（国家）。
						3.与岗位相关联的含金量高的证书等。`
		}
